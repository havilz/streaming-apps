...
import 'package:streaming_mobile/features/home/domain/movie_screen_provider.dart';
...
class _MovieScreenState extends ConsumerState<MovieScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ref.read(movieScreenProvider.notifier).reload();
    });
  ...
  Widget build(BuildContext context) {
    final movieState = ref.watch(movieScreenProvider);
      ...
      body: Stack(
        children: [
          RefreshIndicator(
            ...
            onRefresh: () => ref.read(movieScreenProvider.notifier).reload(),
            child: CustomScrollView(
              controller: _scrollController,
              slivers: [
                SliverToBoxAdapter(
                  child: HeroSection(
                    items: movieState.heroItems,
                ...
                if (movieState.isLoading)
                  ...
                  SliverToBoxAdapter(
                    child: Container(
                      ...
                      child: _buildHorizontalLane(
                        title: 'Trending Now',
                        items: movieState.trendingItems,
                      ),
                    ),
                  ),
                  ...
                  SliverToBoxAdapter(
                    child: Container(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: movieState.genreItems.entries.map((entry) {
                  ...
                  SliverToBoxAdapter(
                    child: Container(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: movieState.countryItems.entries.map((entry) {
                          return _buildHorizontalLane(
