...
final availableCountriesProvider = FutureProvider((ref) {
  return ref.read(homeRepositoryProvider).fetchAvailableCountries();
});
        ...
        children: [
          SafeArea(
            child: RefreshIndicator(
              ...
              onRefresh: () => ref.refresh(availableCountriesProvider.future),
                    ...
                    sliver: SliverToBoxAdapter(
                      child: Column(
                        ...
                        children: [
                          ...
                          AppText(
                            'Temukan film dan serial TV terbaik berdasarkan negara produksi',
                      ...
                      return SliverPadding(
                        ...
                        sliver: SliverGrid(
                          ...
                          delegate: SliverChildBuilderDelegate(
                            (context, index) {
                              ...
                              return Material(
                                ...
                                child: InkWell(
                                  onTap: () {
                                    context.push(
                                      '/countries/${country.id}?name=${Uri.encodeComponent(country.name)}',
                                    );
                                  },
                            ...
                            childCount: countriesList.length,
                          ),
                        ),
                      );
                    },
