...
import 'package:streaming_mobile/features/home/domain/genre_detail_provider.dart';
...
class _GenreDetailScreenState extends ConsumerState<GenreDetailScreen> {
  ...
  Widget build(BuildContext context) {
    final genreAsync = ref.watch(genreDetailProvider(widget.genreId));
                    ...
                    SliverToBoxAdapter(
                      child: Container(
                        ...
                        child: _buildHorizontalLane(
                          title: 'Trending ${widget.genreName}',
                    ...
                    SliverToBoxAdapter(
                      child: Container(
                        ...
                        child: _buildHorizontalLane(
                          ...
                          items: genreState.bestCountryItems,
                        ),
                      ),
                    ),
